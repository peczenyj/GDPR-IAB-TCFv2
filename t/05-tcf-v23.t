...
subtest "TCF v2.3 segments" => sub {
    ...
    ok !$consent->disclosed_vendor(9999),
      'vendor 9999 should NOT be disclosed';

    # Allowed vendors check (not present in this string)
    ok !$consent->allowed_vendor(284),
      'vendor 284 should NOT be in allowed vendors segment (segment missing)';
};
